...
<template>
  ...
  <div v-if="showModal" class="fixed z-10 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen bg-black/[.15] px-4">
      <div class="itbkk-modal-alert bg-white p-6 rounded-lg w-full max-w-3xl sm:w-full md:w-11/12 lg:w-8/12 xl:w-6/12">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 border-b-2 pb-4">
        ...
        <div class="mb-4 flex flex-col md:flex-row md:space-x-4">
          <div class="w-full md:w-6/12 mb-4 md:mb-0">
            ...
            <input
              ...
              class="itbkk-collaborator-email border border-black rounded-lg py-2 px-3 input input-ghost w-full"
            />
          ...
          <div class="w-full md:w-5/12">
            ...
            <select
              class="itbkk-access-right border border-black rounded-lg h-10 w-full pl-3"
